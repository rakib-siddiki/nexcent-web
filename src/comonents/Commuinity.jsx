...
const Commuinity = () => {
  return (
    <>
      <section id="Testimonial" className="pt-12 pb-32 xl:pb-[174px]">
        ...
        <div className="container md:flex justify-between md:gap-x-4 xl:gap-0">
          ...
          <div className="flex justify-center md:block md:w-64 lg:w-80 xl:w-full">
            <div className="relative mt-4">
              ...
              <div className="md:w-52 lg:w-56 xl:w-[317px] bg-behind text-center rounded-lg absolute top-3/4 left-0 scale-90 md:scale-100  md:left-3 lg:left-11 xl:left-6 md:h-36 xl:h-auto p-4 shadow-commuinity">
